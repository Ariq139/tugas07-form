	...
	<body>
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			if (empty($_POST["website"])) {
				...
				if (!preg_match("/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-az0-9+&@#\/%=~_|]/i",$website)) {
		...
		<table border="0">
			...
			<tr>
				...
				<input type="radio" name="gender" <?php if (isset($gender) && $gender=="Laki-laki") echo "checked";?> value="Laki-laki">Laki-laki <span class="error"> * <?php echo $genderErr;?></span>
				</td>
			</tr>
			<tr>
				<td>Alamat</td>
